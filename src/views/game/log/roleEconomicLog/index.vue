        ...
        <div class="table-page-search-wrapper">
            <a-form @submit="handleSubmit" layout="inline" :form="form">
                <a-row :gutter="12">
                    ...
                    <a-col :md="4">
                        <a-form-item label="角色名">
                            <a-input v-decorator="['role_name']" style="width: 100%" allowClear />
                        </a-form-item>
                    </a-col>
                    <a-col :md="3">
                ...
                <a-row :gutter="12">
                    ...
                    <a-col :md="4">
                        <a-form-item label="经济类型">
                            <a-select v-decorator="['item_id']" placeholder="请选择">
                                <a-select-option value="20009">钻石</a-select-option>
                                <a-select-option value="20001">能量</a-select-option>
                                <a-select-option value="21002">积分</a-select-option>
                            </a-select>
                        </a-form-item>
                    </a-col>
                    <a-col :md="3">
    ...
    data() {
        return {
            ...
            loadData: parameter => {
                ...
                return this.$api.LOG_ROLE_ECONOMIC_ALL({
                        ...this.queryParam,
                        ...params
                    })
                    .then(res => {
        ...
        handleExport() {
            this.form.validateFields((err, values) => {
                if (!err) {
                    ...
                    this.$api.LOG_ROLE_ECONOMIC_EXPORT({
                        ...values,
                        ...params
                    }).then(res => {
                        if (res.Success) {
