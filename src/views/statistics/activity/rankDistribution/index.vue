                ...
                <a-row :gutter="12">
                    ...
                    <a-col :md="4">
                        <a-form-item label="区服">
                            <a-select showSearch optionFilterProp="children" :filterOption="filterOption" placeholder="请选择" name="server_id" v-decorator="['server_id']">
                    ...
                    <a-col :md="4">
                        <a-form-item label="等级步长">
                            <a-input v-decorator="['foot']" allowClear style="width: 100%" />
                        </a-form-item>
                    </a-col>
                    <a-col :md="2">
...
export default {
    mixins: [mixin],
    name: 'statistics-activity-rankDistribution',
    components: {
        MddTable,
    },
    data() {
        return {
            ...
            loadData: parameter => {
                ...
                return this.$api.ACTIVITY_RANK_DISTRIBUTION_ALL({
                        ...params,
                        ...this.queryParam
                    })
                    .then(res => {
        ...
        handleExport() {
            this.form.validateFields((err, values) => {
                if (!err) {
                    ...
                    this.$api.ACTIVITY_RANK_DISTRIBUTION_EXPORT({
                        ...values,
                        ...params
                    }).then(res => {
                        if (res.Success) {
