...
export default {
    mixins: [mixin],
    name: 'statistics-survey-stageAmountPeopleRatioGramdTotal',
    components: {
        MddTable,
    },
    data() {
        return {
            ...
            loadData: parameter => {
                return this.$api.OVERVIEW_STAGE_AMOUNT_PEOPLE_RATIO_GRAMD_TOTAL_ALL(this.queryParam)
                    .then(res => {
                        let data = {
                            data: []
                        }
        ...
        handleExport() {
            this.form.validateFields((err, values) => {
                if (!err) {
                    ...
                    this.$api.OVERVIEW_STAGE_AMOUNT_PEOPLE_RATIO_GRAMD_TOTAL_ALL_EXPORT({
                        ...values,
                        ...params
                    }).then(res => {
                        if (res.Success) {
