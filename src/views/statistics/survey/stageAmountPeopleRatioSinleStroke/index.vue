...
export default {
    mixins: [mixin],
    name: 'statistics-survey-stageAmountPeopleRatioSinleStroke',
    components: {
        MddTable,
    },
    data() {
        return {
            ...
            loadData: parameter => {
                return this.$api.OVERVIEW_STAGE_AMOUNT_PEOPLE_RATIO_SINGLE_STROKE_ALL(this.queryParam)
                    .then(res => {
                        let data = {
                            data: []
                        }
        ...
        handleExport() {
            this.form.validateFields((err, values) => {
                if (!err) {
                    ...
                    this.$api.OVERVIEW_STAGE_AMOUNT_PEOPLE_RATIO_SINGLE_STROKE_EXPORT({
                        ...values,
                        ...params
                    }).then(res => {
