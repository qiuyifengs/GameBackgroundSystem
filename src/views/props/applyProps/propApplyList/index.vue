...
<a-card :bordered="false">
    ...
    <div class="table-operator" style="margin-bottom: 24px">
        <a-button type="primary" icon="plus" @click="$refs.createModal.add()">能量申请</a-button>
    </div>
    <create-energy-apply-form ref="createModal" @ok="handleOk" />
...
import CreateEnergyApplyForm from '../modules/CreateEnergyApplyForm'
...
export default {
    mixins: [mixin],
    name: 'props-applyProps-propApplyList',
    components: {
        MddTable,
        CreateEnergyApplyForm
    },
    data() {
        return {
            ...
            loadData: parameter => {
                ...
                return this.$api.APPLY_ENERGY_ALL(Object.assign(params, this.queryParam))
                    .then(res => {
                        let data = {}
                        if (res.Success) {
                            data = {
