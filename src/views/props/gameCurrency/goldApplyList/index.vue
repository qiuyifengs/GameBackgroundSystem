...
<a-card :bordered="false">
    ...
    <div class="table-operator" style="margin-bottom: 24px">
        <a-button type="primary" icon="plus" @click="$refs.createModal.add()">道具申请</a-button>
    </div>
    <create-gold-apply-form ref="createModal" @ok="handleOk" />
...
import CreateGoldApplyForm from '../modules/CreateGoldApplyForm'
...
export default {
    mixins: [mixin],
    name: 'props-gameCurrency-goldApplyList',
    components: {
        MddTable,
        CreateGoldApplyForm
    },
    data() {
        return {
            ...
            loadData: parameter => {
                ...
                return this.$api.APPLY_GOLD_ALL(Object.assign(this.queryParam, params))
                    .then(res => {
                        let data = {}
                        if (res.Success) {
                            data = {
